/*
    Object          : SSIS catalogue environment WWI_DEV
    ...
    Notes           : GENERATED FILE - do not edit by hand. Rendered from
                      config/environments/dev.env.yaml by
...
DECLARE @FolderName      NVARCHAR(128) = N'WWI_DEV';
DECLARE @EnvironmentName NVARCHAR(128) = N'WWI_DEV';
...
BEGIN
    EXEC catalog.create_environment
         ...
         @environment_description = N'Shared development environment. Restored from a masked PROD backup on the first Sunday of each month, which is why watermarks are reset by hand afterwards and why the nightly job is left disabled for the rest of that day.';
END
GO
...
IF EXISTS (SELECT 1
           ...
           WHERE v.name = N'OracleHost' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
         @variable_name = N'OracleHost';
END

DECLARE @Value NVARCHAR(4000) = N'$(OracleHost)';
EXEC SSISDB.catalog.create_environment_variable
     @folder_name      = N'WWI_DEV',
     @environment_name = N'WWI_DEV',
     @variable_name    = N'OracleHost',
     @data_type        = N'String',
     @sensitive        = 0,
     @value            = @Value,
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'OraclePort' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'OracleService' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'OracleUser' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'OracleProvider' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'OraclePassword' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'SqlServerHost' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'SqlServerPort' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'SqlServerUser' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'SqlServerProvider' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'SqlServerTrustServerCertificate' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'SqlServerPassword' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'SqlServerOltpDb' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'SqlServerStagingDb' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'SqlServerDwDb' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'InboundFileRoot' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'ArchiveFileRoot' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'QuarantineFileRoot' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'DefaultBatchSize' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'SourceQueryTimeoutSeconds' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'MaxRejectPercent' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.environments AS e ON e.environment_id = v.environment_id
           INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = e.folder_id
           WHERE v.name = N'EnvironmentCode' AND e.name = N'WWI_DEV' AND f.name = N'WWI_DEV')
BEGIN
    EXEC SSISDB.catalog.delete_environment_variable
         @folder_name = N'WWI_DEV', @environment_name = N'WWI_DEV',
...
IF NOT EXISTS (SELECT 1
               ...
               WHERE p.name = N'WWI_Orchestration' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
...
IF EXISTS (SELECT 1
           ...
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Orchestration'
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Extract_Oracle' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Extract_Oracle'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Extract_SqlServer' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Extract_SqlServer'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Ingest_Files' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Ingest_Files'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Staging' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Staging'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_DataQuality' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_DataQuality'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_ReferenceData' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_ReferenceData'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Dimensions' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Dimensions'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Facts' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Facts'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Aggregates' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Aggregates'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Finance' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Finance'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Sales' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Sales'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Inventory' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Inventory'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Procurement' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Procurement'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Customer360' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Customer360'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_ErrorHandling' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_ErrorHandling'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Maintenance' AND f.name = N'WWI_DEV'
                 AND r.environment_name = N'WWI_DEV')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS pr ON pr.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f  ON f.folder_id  = pr.folder_id
           WHERE f.name = N'WWI_DEV' AND pr.name = N'WWI_Maintenance'
             AND op.object_type = 20 AND op.parameter_name = N'OracleHost')
BEGIN
    EXEC SSISDB.catalog.set_object_parameter_value
         @object_type    = 20,                     /* project parameter */
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
           INNER JOIN SSISDB.catalog.folders  AS f ON f.folder_id  = p.folder_id
           WHERE f.name = N'WWI_DEV'
             AND ISNULL(r.environment_folder_name, N'WWI_DEV') <> N'WWI_DEV')
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.folders  AS f ON f.folder_id  = p.folder_id
           WHERE f.name = N'WWI_DEV' AND op.sensitive = 1 AND op.value_type = 'V')
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f ON f.folder_id  = p.folder_id
           WHERE f.name = N'WWI_DEV' AND op.value_type = 'R'
             AND NOT EXISTS (SELECT 1
                             ...
                             WHERE ef.name = N'WWI_DEV'
                               AND e.name = N'WWI_DEV'
...
IF EXISTS (SELECT 1
           ...
           INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = op.project_id
           INNER JOIN SSISDB.catalog.folders  AS f ON f.folder_id  = p.folder_id
           WHERE f.name = N'WWI_DEV' AND op.object_type = 20
