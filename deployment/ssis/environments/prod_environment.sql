...
IF NOT EXISTS (SELECT 1
               ...
               WHERE p.name = N'WWI_Orchestration' AND f.name = N'WWI_PROD'
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Extract_Oracle' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Extract_SqlServer' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Ingest_Files' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Staging' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_DataQuality' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_ReferenceData' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Dimensions' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Facts' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Aggregates' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Finance' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Sales' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Inventory' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Procurement' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Customer360' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_ErrorHandling' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
...
IF NOT EXISTS (SELECT 1
               ...
               INNER JOIN SSISDB.catalog.projects AS p ON p.project_id = r.project_id
               INNER JOIN SSISDB.catalog.folders AS f ON f.folder_id = p.folder_id
               WHERE p.name = N'WWI_Maintenance' AND f.name = N'WWI_PROD'
                 AND r.environment_name = N'WWI_PROD')
BEGIN
    DECLARE @ReferenceId BIGINT;
    EXEC SSISDB.catalog.create_environment_reference
