...
# config/environments/test.env.yaml by deployment/ssis/render_environment_sql.py.
#
...
@{
    'OracleHost' = @{ EnvVar = 'ORACLE_HOST'; Default = 'oracle-erp-test.internal.example'; Secret = $false }
    'OraclePort' = @{ EnvVar = 'ORACLE_PORT'; Default = '1521'; Secret = $false }
    'OracleService' = @{ EnvVar = 'ORACLE_SERVICE'; Default = 'WWIGERPT'; Secret = $false }
    'OracleUser' = @{ EnvVar = 'ORACLE_USER'; Default = 'WWI_ETL_TEST'; Secret = $false }
    ...
    'SqlServerHost' = @{ EnvVar = 'SQLSERVER_HOST'; Default = 'sqltest01.internal.example'; Secret = $false }
    ...
    'InboundFileRoot' = @{ EnvVar = 'ETL_INBOUND_FILE_ROOT'; Default = '\\wwi-files-test\landing\inbound'; Secret = $false }
    'ArchiveFileRoot' = @{ EnvVar = 'ETL_ARCHIVE_FILE_ROOT'; Default = '\\wwi-files-test\landing\archive'; Secret = $false }
    'QuarantineFileRoot' = @{ EnvVar = 'ETL_QUARANTINE_FILE_ROOT'; Default = '\\wwi-files-test\landing\quarantine'; Secret = $false }
    'DefaultBatchSize' = @{ EnvVar = 'ETL_DEFAULT_BATCH_SIZE'; Default = '50000'; Secret = $false }
    'SourceQueryTimeoutSeconds' = @{ EnvVar = 'ETL_SOURCE_QUERY_TIMEOUT_SECONDS'; Default = '1800'; Secret = $false }
    'MaxRejectPercent' = @{ EnvVar = 'ETL_MAX_REJECT_PERCENT'; Default = '5'; Secret = $false }
    'EnvironmentCode' = @{ EnvVar = 'ETL_ENVIRONMENT_CODE'; Default = 'TEST'; Secret = $false }
}
