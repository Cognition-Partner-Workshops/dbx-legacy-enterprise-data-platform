...
CREATE TABLE [Fact].[Order Fulfilment] (
    ...
    [Order Line Count]              INT             NULL,
    [Transaction Currency Code]     NVARCHAR (3)    NULL,
    ...
    [Pipeline Status Code]          NVARCHAR (12)   NULL,
    [Stalled Flag]                  BIT             NULL,
    [Stalled Reason Code]           NVARCHAR (10)   NULL,
