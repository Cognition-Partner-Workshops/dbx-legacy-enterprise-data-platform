...
(
    ...
    UPDATED_DT              DATE,
    /* The table is index organized, so the primary key index is the table and
       cannot carry its own storage clause (ORA-25176). */
    CONSTRAINT PK_GL_PERIOD_STATUS PRIMARY KEY (LEDGER_CD, PERIOD_CD),
